  ...
  return (
    ...
    >
      <PrismicRichText
        ...
        components={{
          heading2: ({ children }) => (
            <h2 className="text-balance text-left text-5xl font-medium md:text-7xl block w-full">
              {children}
            </h2>
          ),
          em: ({ children }) => (
      ...
      <div className=" mt-6 max-w-md text-balance text-center text-slate-300 mr-auto">
